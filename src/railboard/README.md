...
- `matrix-waveshare-rgb` and `provision` build, 0 warnings. `tools/flag_matrix.py`:
  **24/24** as intended, including `rail direct + board` building and
  `rail direct, no board` refused (2026-09-14, on `d8f2962`).
...
`RAILBOARD_DIRECT_ENABLED` against `1c82839`: **+24 572 B flash, +248 B RAM**
(static; 1 933 961 → 1 958 533 and 92 236 → 92 484). Most of the flash is
