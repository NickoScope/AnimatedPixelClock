...
<section><h2>Сцены</h2><div class="g" id="scenes"></div><p class="hint">Первое касание ручки возвращает панель на её страницу.</p></section>
<section><h2>Любой экран в 3D</h2><div class="g" id="looks"></div><p class="hint">Режим остаётся на всех страницах, пока не выбрано «как есть». Выпуклость, слои, парение и купол — для очков; покачивание, карточка, рельеф и барабан — без очков.</p></section>
