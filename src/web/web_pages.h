// The config portal's page, style, script and icon, as the source that
...
//
// Four blobs:
//   PAGE_HTML   - served from /; no version in its URL, so not cached for a year.
//   PORTAL_CSS  - styles, served from /portal.css (versioned, long cache).
//   PORTAL_JS   - interactions, served from /portal.js (versioned, long cache).
//   FAVICON_SVG - brand mark, served from /favicon.svg and /favicon.ico.
//
// The page is static and the same for every build. PORTAL_JS fills it from
// /api/portal (handlePortalValues in web.cpp) and keeps Save disabled until it
// has, so a control added to the settings form needs its value there too; the
// generator refuses one that /api/portal does not fill. The generator resolves
// three markers, the panel none: %PANEL_NAV% and %PANEL_PAGES% (web_panel_page.h)
// and ?v=%ASSETVER% (a hash of the file the URL names). Any other %TOKEN% is
// refused.
#pragma once
#include <Arduino.h>
...
// ============================================================================
//  PAGE_HTML - the page. PORTAL_JS fills it in from /api/portal.
// ============================================================================
...
<div class="workspace">
  ...
  <aside class="sidebar">
    ...
    <div class="about">
      ...
      <a href="https://github.com/NickoScope/AnimatedPixelClock" target="_blank" rel="noopener"><span class="gh" aria-hidden="true"></span>github.com/NickoScope</a>
      <span class="line">upstream <a href="https://github.com/Keralots/AnimatedPixelClock" target="_blank" rel="noopener">github.com/Keralots</a></span>
    </div>
  </aside>

  <main class="content">
    <div class="content-inner">
      <form id="cfgForm" class="cfg-wait" action="/save" method="POST">
        ...
        <section class="page active" data-page="clock">
          ...
          <div class="card">
            ...
            <div class="subcard" id="cycleSettings" style="display:none">
              ...
              <input type="hidden" id="cycleConfig" name="cycleConfig">
            ...
            <div class="subcard" id="marioSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="marioBounceHeight" id="marioBounceHeight" min="10" max="50" step="5" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="marioBounceSpeed" id="marioBounceSpeed" min="2" max="15" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="marioWalkSpeed" id="marioWalkSpeed" min="15" max="35" step="1" data-div="10" data-fixed="1">
            ...
            <div class="subcard" id="spaceSettings" style="display:none">
              ...
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="spacePatrolSpeed" id="spacePatrolSpeed" min="2" max="15" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="spaceAttackSpeed" id="spaceAttackSpeed" min="10" max="40" step="5" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="spaceLaserSpeed" id="spaceLaserSpeed" min="20" max="80" step="5" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="spaceExplosionGravity" id="spaceExplosionGravity" min="3" max="10" step="1" data-div="10" data-fixed="1">
            ...
            <div class="subcard" id="pongSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pongBallSpeed" id="pongBallSpeed" min="16" max="30" step="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pongBounceStrength" id="pongBounceStrength" min="1" max="8" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pongBounceDamping" id="pongBounceDamping" min="50" max="95" step="5" data-div="100" data-fixed="2">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pongPaddleWidth" id="pongPaddleWidth" min="10" max="40" step="2" data-suffix="px">
            ...
            <div class="subcard" id="pacmanSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pacmanSpeed" id="pacmanSpeed" min="5" max="30" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pacmanEatingSpeed" id="pacmanEatingSpeed" min="10" max="50" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pacmanMouthSpeed" id="pacmanMouthSpeed" min="5" max="20" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="pacmanPelletCount" id="pacmanPelletCount" min="0" max="20" step="1">
            ...
            <div class="subcard" id="snakeSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="snakeSpeed" id="snakeSpeed" min="5" max="30" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="snakeLength" id="snakeLength" min="4" max="12" step="1">
            ...
            <div class="subcard" id="tetrisSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="tetrisFallSpeed" id="tetrisFallSpeed" min="5" max="30" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="tetrisDotSpeed" id="tetrisDotSpeed" min="5" max="30" step="1" data-div="10" data-fixed="1">
            ...
            <div class="subcard" id="asteroidsSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="asteroidsShipSpeed" id="asteroidsShipSpeed" min="5" max="25" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="asteroidsRockSpeed" id="asteroidsRockSpeed" min="3" max="20" step="1" data-div="10" data-fixed="1">
                ...
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="asteroidsRockCount" id="asteroidsRockCount" min="1" max="4" step="1">
            ...
            <div class="subcard" id="dinoSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="dinoSpeed" id="dinoSpeed" min="5" max="30" step="1" data-div="10" data-fixed="1">
            ...
            <div class="subcard" id="matrixSettings" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <div class="range-row">
                    <input type="range" name="matrixRainSpeed" id="matrixRainSpeed" min="5" max="30" step="1" data-div="10" data-fixed="1">
            ...
            <div class="subcard" id="weatherSettings" style="display:none">
              ...
              <div class="grid-2" style="margin-top:12px">
                <div class="field" style="margin-bottom:0">
                  ...
                  <input type="number" name="weatherLat" id="weatherLat" step="0.0001" min="-90" max="90">
                </div>
                <div class="field" style="margin-bottom:0">
                  <label class="field-label" for="weatherLon">Longitude</label>
                  <input type="number" name="weatherLon" id="weatherLon" step="0.0001" min="-180" max="180">
                </div>
              </div>
              <label class="check-row standalone" style="margin-top:16px">
              ...
              <div class="field" style="margin:16px 0 0">
                ...
                <input type="text" name="weatherApiKey" id="weatherApiKey" maxlength="32" placeholder="Leave empty for the free endpoint">
        ...
        <section class="page" data-page="display">
          ...
          <div class="card">
            ...
            <div class="grid-2">
              ...
              <div class="field" style="margin-bottom:0">
                ...
                <div class="range-row">
                  <input type="range" name="colonBlinkRate" id="colonBlinkRate" min="5" max="50" step="5" data-div="10" data-fixed="1" data-suffix="Hz">
          ...
          <div class="card">
            ...
            <div class="field">
              ...
              <div class="range-row">
                <input type="range" name="displayBrightness" id="displayBrightness" min="1" max="255" step="5" data-pct="1">
            ...
            <div class="subcard" id="nightFields" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <input type="time" name="dimStartTime" id="dimStartTime">
                </div>
                <div class="field" style="margin-bottom:0">
                  <label class="field-label" for="dimEndTime">Until</label>
                  <input type="time" name="dimEndTime" id="dimEndTime">
                </div>
              </div>
              <div class="field" style="margin:18px 0 0">
                <label class="field-label" for="dimBrightness">Night brightness</label>
                <div class="range-row">
                  <input type="range" name="dimBrightness" id="dimBrightness" min="1" max="255" step="5" data-pct="1">
            ...
            <div class="subcard" id="offFields" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0">
                  ...
                  <input type="time" name="offStartTime" id="offStartTime">
                </div>
                <div class="field" style="margin-bottom:0">
                  <label class="field-label" for="offEndTime">Until</label>
                  <input type="time" name="offEndTime" id="offEndTime">
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="page" data-page="viz">
          ...
          <div class="card" id="vizOptionsCard">
            ...
            <div id="vizClassicColors" style="display:none">
              ...
              <div style="margin-top:8px" id="colorsViz"></div>
            </div>
            <div id="vizScopeOptions" style="display:none">
              ...
              <div style="margin-top:8px" id="colorsScope"></div>
              <label class="check-row standalone" style="margin-top:12px">
              ...
              <div class="field" style="margin-top:12px">
                ...
                <input type="number" name="scopeGain" id="scopeGain" min="50" max="200" step="5">
        ...
        <section class="page" data-page="layout">
          ...
          <div class="card">
            ...
            <div class="field">
              ...
              <input type="number" name="clockOffset" id="clockOffset" min="-20" max="20">
        ...
        <section class="page" data-page="network">
          ...
          <div class="card">
            ...
            <div class="field" style="margin-bottom:0">
              ...
              <input type="text" name="deviceName" id="deviceName" maxlength="31" pattern="^[a-zA-Z][a-zA-Z0-9-]*$">
          ...
          <div class="card">
            ...
            <div class="subcard" id="staticFields" style="display:none">
              <div class="grid-2">
                <div class="field" style="margin-bottom:0"><label class="field-label" for="staticIP">Static IP</label><input type="text" name="staticIP" id="staticIP" placeholder="192.168.1.100" pattern="^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$"></div>
                <div class="field" style="margin-bottom:0"><label class="field-label" for="gateway">Gateway</label><input type="text" name="gateway" id="gateway" placeholder="192.168.1.1" pattern="^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$"></div>
                <div class="field" style="margin-bottom:0"><label class="field-label" for="subnet">Subnet mask</label><input type="text" name="subnet" id="subnet" placeholder="255.255.255.0" pattern="^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$"></div>
                <div class="field" style="margin-bottom:0"><label class="field-label" for="dns1">Primary DNS</label><input type="text" name="dns1" id="dns1" placeholder="8.8.8.8" pattern="^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$"></div>
                <div class="field" style="margin-bottom:0"><label class="field-label" for="dns2">Secondary DNS</label><input type="text" name="dns2" id="dns2" placeholder="8.8.4.4" pattern="^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$"></div>
              </div>
            </div>
            <div class="note warn">
          ...
          <div class="card">
            ...
            <div class="grid-2">
              <div class="field" style="margin-bottom:0"><label class="field-label" for="ntpServer1">Primary NTP</label><input type="text" name="ntpServer1" id="ntpServer1" maxlength="63" placeholder="pool.ntp.org"></div>
              <div class="field" style="margin-bottom:0"><label class="field-label" for="ntpServer2">Secondary NTP</label><input type="text" name="ntpServer2" id="ntpServer2" maxlength="63" placeholder="time.nist.gov"></div>
            </div>
        ...
        <section class="page" data-page="firmware">
          ...
          <div class="card">
            ...
            <div class="crt oled-preview" style="max-width:360px">
              <div class="oled-pv-head"><span class="ttl">installed</span><span class="meta">ESP32-S3 &middot; HUB75 Matrix</span></div>
      ...
      <div data-need="panel">%PANEL_PAGES%</div>
    </div>
  </main>
</div>
</div>
...
<div class="save-bar">
  <div class="save-bar-inner">
    <div class="save-meta wait" id="saveMeta"><span class="dot"></span><span class="txt">Loading settings...</span></div>
    <button type="button" class="btn" id="cfgRetry" style="display:none">Retry</button>
    <button type="submit" form="cfgForm" class="btn btn-accent btn-lg" id="saveBtn" disabled>Save &amp; apply</button>
  </div>
</div>
...
if (quiet) return;   // a fallback, not the reader's choice: nothing to remember
window.scrollTo(0, 0);
closeNav();
...
var loaded = false;   // true once /api/portal has filled the form (loadValues)
function markDirty() { if (loaded && saveMeta) { saveMeta.classList.remove('clean'); $('.txt', saveMeta).textContent = 'Unsaved changes'; } }
function markClean(txt) { if (saveMeta) { saveMeta.className = 'save-meta clean'; $('.txt', saveMeta).textContent = txt || 'All saved'; } }
var form = $('#cfgForm');
...
$$('input[type="range"]').forEach(function (inp) { inp.addEventListener('input', function () { fmtRange(inp); }); });
...
function startMetrics() {   // once the values are in: the preview draws with the row mode and clock settings
fetch('/metrics').then(function (r) { return r.json(); }).then(function (data) {
if (data.time) DEVTIME = data.time;
...
e.preventDefault();
if (!loaded) return;   // never from a half-loaded form; Save stays disabled until then
saveFormState();
...
$('#clockStyle').addEventListener('change',showCycle);
...
// ---- Values ----
// The page is one static file for every build, and /api/portal fills it in.
// Until it has, the settings stay dimmed and Save stays disabled, so nothing is
// saved from a half-loaded form. The Panel group's markup is in every copy of
// the page: the parts this build does not carry go here, and panel.css and
// panel.js are loaded only where there is a Panel group.
var saveBtn = $('#saveBtn'), cfgRetry = $('#cfgRetry'), featuresIn = false;
function applyFeatures(list) {
if (featuresIn) return;
featuresIn = true;
var F = {}, root = $('#panelRoot'), html = document.documentElement;
String(list || '').split(' ').forEach(function (k) { if (k) F[k] = 1; });
$$('[data-need]').forEach(function (el) { if (!F[el.getAttribute('data-need')] && el.parentNode) el.parentNode.removeChild(el); });
...
return d.colorRows.filter(function (r) { return r[1] === style; }).map(function (r) { return colorRow(r[0], r[2], d.spriteColors[r[0]]); }).join('');
}
function place(id, html, outer) { var el = document.getElementById(id); if (el) el[outer ? 'outerHTML' : 'innerHTML'] = html; }
function buildColors(d) {
// The Clock page's card: each style's sprite rows and its time-digit row, shown by syncClockPanels.
...
html += '<div class="digitc" data-ds="' + r[0] + '" style="display:none">' + colorRow(r[1], 'Time digits + colon', d.spriteColors[r[1]]) + '</div>';
});
html += '<label style="display:flex;align-items:center;gap:8px;margin-top:12px"><input type="checkbox" name="resetSpriteColors" value="1"> Reset all sprite colors to defaults on save</label></div>';
place('colorsClock', html, true);
var pc = colorRows(d, -2);
place('colorsPc', pc ? '<div class="card"><h2 class="card-title">Colors</h2>' + pc + '</div>' : '', true);
...
el.namedItem('displayBrightness').min = el.namedItem('dimBrightness').min = d.minBright;
...
['tbVer', 'aboutVer', 'fwVer'].forEach(function (id) { $('#' + id).textContent = 'v' + d.ver; });
$('#fwBuilt').textContent = d.built;
$('#fwHeap').textContent = (d.freeHeap / 1024).toFixed(1) + ' KB';
$('#srIp').textContent = d.ip;
$('#srHost').textContent = $('#hostPreview').textContent = v.deviceName;
syncs.forEach(function (fn) { fn(); });
$$('input[type="range"]').forEach(function (inp) { fmtRange(inp); });
initCycle();
}
function cfgState(txt, cls) { saveMeta.className = 'save-meta ' + cls; $('.txt', saveMeta).textContent = txt; }
function loadValues() {
cfgRetry.style.display = 'none';
cfgState('Loading settings...', 'wait');
...
applyValues(d);
loaded = true;
form.classList.remove('cfg-wait');
saveBtn.disabled = false;
markClean();
animRefresh();
startMetrics();
}).catch(function (err) {
cfgState('Settings did not load (' + (err && err.message ? err.message : err) + ')', 'err');
cfgRetry.style.display = '';
});
}
