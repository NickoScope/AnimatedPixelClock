...
static const char PANEL_PAGES_HTML[] PROGMEM = R"PNL(<link rel="stylesheet" href="/panel.css?v=%ASSETVER%">
      ...
      <section class="page" data-page="ptrains" data-need="trains">
        ...
        <div class="card">
          <h2 class="card-title">Station <span class="tag" id="rbStnTag">--</span></h2>
          <div class="grid-2">
            <div class="field" style="margin-bottom:0">
              <label class="field-label" for="rbCrs">Station code</label>
              <input type="text" id="rbCrs" class="pn-crs" maxlength="3" autocomplete="off" spellcheck="false" autocapitalize="characters" placeholder="GLD" aria-describedby="rbStnMsg">
              <p class="field-hint">The three-letter code National Rail gives the station: GLD is Guildford.</p>
            </div>
            <div class="field" style="margin-bottom:0">
              <span class="field-label">Following</span>
              <p class="pn-stn" id="rbNow">--</p>
            </div>
          </div>
          <div class="chip-tray pn-chips" id="rbPresets" style="margin-top:14px"></div>
          <div class="page-actions">
            <button type="button" class="btn btn-accent" id="rbSet">Set station</button>
          </div>
          <p class="field-hint" id="rbStnMsg">Kept across reboots. The panel publishes the choice to Home Assistant, which fetches the new station straight away.</p>
        </div>
        ...
        <div class="card">
          ...
          <div class="status-readout pn-readout">
            ...
            <dl class="sr-rows">
              <div class="sr-row"><dt>showing</dt><dd id="rbList">--</dd></div>
          ...
          <label class="check-row standalone" style="margin-top:16px">
            ...
            <span class="check-box" aria-hidden="true"></span>
            <span class="check-text"><strong>Diagnostics on the panel</strong><span class="ct-hint">Keeps the diagnostics view on screen instead of the lists. Inside the page the knob steps departures, arrivals, diagnostics; turning it off diagnostics clears this too. Off also clears a diagnostics setting from Home Assistant until it sends its config again.</span></span>
          </label>
          <div class="page-actions">
